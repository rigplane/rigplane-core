...
for a curated one: every commit in `769bfc71..main`, none omitted** — the
...
- **Defect fixes in the same subsystem, ahead of the rows:** MOR-1879
  ...
  poller). **Unchecked by this change:** MOR-1903 is characterised in §3.5 and
