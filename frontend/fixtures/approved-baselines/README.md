...
| `peer-split-chassis--desktop` | MOR-2243 — the segmentline peer-split glass chassis (`PeerSplitLayout.svelte`, the only file that mounts `ScaledStage`); at this frame size its stage scale resolves to exactly 1, the identity transform |
