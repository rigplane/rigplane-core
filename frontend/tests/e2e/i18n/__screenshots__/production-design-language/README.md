...
## Linux re-pin provenance (current — 2026-08-13 MOR-1474 TX wording)
...
Only `studioline--dark--production-root.png` was regenerated by this
re-pin; `studioline--light--production-root.png`,
`fieldline--dark--production-root.png`, and
`fieldline--light--production-root.png` were left untouched — the RxTx
surface this ticket changed renders identically across workspace/theme,
and none of the other three images crossed this run's comparator
threshold.
...
| `studioline--light--production-root.png` | persisted StudioLine × light | `081e5deab62478505deb4cf89a06178d5f870f05d68a8c46a478e94788da3a38` |
