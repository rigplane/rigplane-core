...
export const WORKSPACE_ZONE_IDS = ['receiver-deck', 'rx-tx', 'primary-vfo', 'secondary-vfo', 'global', 'portrait-deck', 'control-column', 'tx-aux', 'meters', 'scope-display', 'filter', 'rf-front-end', 'band', 'antenna', 'rit-xit-scan', 'repeater', 'rx-audio', 'dsp', 'cw-keyer', 'memory', 'scope-controls', 'peer-columns'] as const;
