...
describe('MOR-1082 — the single-composition order comes from the same plan', () => {
  ...
  it('flattens the plan in zone-declaration order, deduped', () => {
    ...
    // three MOR-1367 (S8) zones, the MOR-2111 repeater zone, the MOR-1368 (S9)
    // rx-audio/dsp/cw-keyer zones, the MOR-2425 (Memory lane, phase B2)
    // memory zone and the MOR-1370 (S6b-2) scope-controls zone — flattening
    // never drops a later zone.
    //
