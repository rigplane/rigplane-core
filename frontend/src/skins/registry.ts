 ...
 * - `hardware-scope` — `SpectrumPanel` on desktop/sdr-test/mobile, plus the
 *   read-only panadapter-first display's wiring-owned demand.
 ...
 *   and the segmentline B/D glass instruments. The mobile layout has none.
 *
