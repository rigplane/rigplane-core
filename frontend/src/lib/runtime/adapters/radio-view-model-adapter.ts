 ...
 * (`Capabilities.preValues`/`.attValues`, verbatim) — see
  ...
  * UI-convenience fallback (no rig profile declares those values — the
  * IC-7610's actual ATT ladder is 16 × 3 dB steps per `rigs/ic7610.toml`;
  * X6200 lesson: no radio-specific tables in the fact layer).
 *
