<script lang="ts">
  ...
  import type { PanelChrome } from '../../wiring/instrument-composition';
  ...
  let {
    surface, view, pendingPreamp = null, onPreampChange, onLevelChange, chrome,
  }: {
...
<div class="desktop-control-face">
  <SemanticControlPanel {surface} {...chrome}>
