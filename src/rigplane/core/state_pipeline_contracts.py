...
#: despite being operator-adjustable. ``tuner_status`` is here (MOR-2596):
#: the end of a tune is radio-driven, so the TUNE badge follows the poll
#: cadence, and the setting class would clear it up to 30 s late.
