...
Canonical location: icom_lan.runtime._control_phase
...
makes ``icom_lan._control_phase`` literally the same module object as
``icom_lan.runtime._control_phase``. This preserves attribute walks
...
from icom_lan.runtime._control_phase import *  # noqa: F401, F403
import icom_lan.runtime._control_phase as _canonical
